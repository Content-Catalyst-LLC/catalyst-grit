...
define('CATALYST_GRIT_DEMO_VERSION', '1.6.0');
...
function catalyst_grit_workspace_shortcode() {
    ...
    wp_localize_script('catalyst-grit-workspace', 'CatalystGritWorkspace', array(
        ...
        'nonce' => wp_create_nonce('catalyst_grit_workspace_v160'),
    ...
    <section class="cg-workspace" data-cg-workspace data-cg-visibility="private" aria-labelledby="cg-workspace-title">
      <header>
        ...
        <h3 id="cg-workspace-title">Private Team Recovery Workspace</h3>
        <p>Save private project, team membership, facilitated review, perspective, agreement, and recovery-record bundles to your own WordPress account. This workspace is not exposed by the public demo shortcode.</p>
      </header>
      ...
      <div class="cg-workspace__team" aria-label="Facilitated review boundaries">
        ...
        <article><h4>Shared agreements</h4><p>Completion requires evidence; blocked agreements identify support needs and preserve append-only history.</p></article>
      </div>
...
function catalyst_grit_workspace_authorize() {
    ...
    check_ajax_referer('catalyst_grit_workspace_v160', 'nonce');
}
...
function catalyst_grit_workspace_save() {
    ...
    update_user_meta(get_current_user_id(), '_catalyst_grit_workspace_v160', $value);
